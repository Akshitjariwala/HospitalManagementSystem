...
public class WardHome {
  ...
  public void checkPatientWiseBedDetails() {
    ...
    if (wardId != -1) {
      ...
      if (patientBeds.size() != 0) {
        ...
        System.out.println("================================================================");
        System.out.println(String.format("%-15s %-10s %-10s %10s %10s", "Patient Name", "|", "Patient Id", "|", "Bed Detail"));
        for (PatientBed patientBed : patientBeds) {
          System.out.println(String.format("%-15s %-10s %-10s %10s %10s", patientBed.getPatientName(), "|", patientBed.getPatientId(), "|", patientBed.getBed().getBedCode()));
        }
      } else {
        System.out.println("==================================================");
  ...
  public int displayWard() {
    ...
    do {
      ...
      System.out.printf("%n");
      System.out.println(String.format("%-10s %-10s %-10s", "Ward Id", " | ", "Ward Name"));
      System.out.println("=====================================");
      for (Ward ward : result) {
        wardIds.add(ward.getWardId());
        System.out.println(String.format("%-10s %-10s %-10s", ward.getWardId(), " | ", ward.getWardName()));
      }
      System.out.printf("%n");
